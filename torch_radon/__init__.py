...
class BaseRadon(abc.ABC):
    ...
    def filter_sinogram(self, sinogram, filter_name="ramp"):
        ...
        sino_fft = torch.view_as_real(torch.fft.fft(padded_sinogram, dim=2, norm="ortho"))
        ...
        filtered_sinogram = torch.real(torch.fft.ifft(torch.view_as_complex(filtered_sino_fft), dim=2, norm="ortho"))
